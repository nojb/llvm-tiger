...
exp:
  ...
  { mkexp 1 (Ebinop (mkexp 1 (Eint 0l), Op_sub, $2)) }
  | exp LAND exp
  { mkexp 2 (Eif ($1, $3, mkexp 3 (Eint 0l))) }
  | exp LOR exp
  { mkexp 2 (Eif ($1, mkexp 3 (Eint 1l), $3)) }
  | exp PLUS exp
  ...
  { match $1.vdesc with
    ...
    | _ -> raise Parse_error }
  | IF exp THEN exp
  { mkexp 1 (Eif ($2, $4, {edesc = Eunit; epos = Parsing.symbol_end_pos ()})) }
